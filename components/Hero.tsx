...
import { getWhyHire, SITE_CONFIG } from '../constants';
import { useLanguage } from '../context/LanguageContext';
import { motion } from 'framer-motion';
import { ArrowRight, CheckCircle2, Sparkles, Phone, MapPin } from 'lucide-react';
    ...
    <section id="about" className="min-h-[90vh] flex items-center pt-20 relative scroll-mt-20">
      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <motion.div
          ...
          className="py-4 pl-1"
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 mb-6 text-xs font-mono font-medium text-emerald-300 border border-emerald-900/50 bg-emerald-950/20 rounded-full backdrop-blur-sm">
            {t('hero.available')}
          </div>
          ...
          <h2 className="text-lg md:text-xl text-emerald-300 mb-4 font-medium h-8 flex items-center">
            <TypewriterText text={benefits[currentBenefitIndex]} />
          </h2>

          <p className="text-neutral-400 leading-relaxed mb-3 max-w-lg">
            {t('hero.desc')}
          </p>

          <p className="text-neutral-300 text-sm mb-2 max-w-lg leading-relaxed">
            {t('hero.bio')}
          </p>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a
              ...
              className="px-6 py-3 border border-emerald-900/50 bg-emerald-950/20 text-emerald-300 font-medium rounded hover:bg-emerald-950/40 hover:text-white transition-all flex items-center justify-center h-12 gap-2"
            >
              <Phone size={16} />
              {t('hero.callMe')}
            </a>
